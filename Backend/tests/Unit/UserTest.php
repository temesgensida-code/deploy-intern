...
class UserTest extends TestCase
{
    ...
    public function test_user_has_fillable_attributes(): void
    {
        ...
        $this->assertEquals(
            ['name', 'email', 'username', 'role', 'is_suspended', 'email_notifications_enabled', 'password', 'cv_path', 'cv_original_name', 'cv_uploaded_at', 'profile_photo_path', 'email_verified_at'],
            $user->getFillable()
        );
    }
